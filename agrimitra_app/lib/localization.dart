...
const Map<String, Map<String, String>> _translations = {
  'en': {
    ...
    'crop_rotation_subtitle': 'Get AI-powered crop rotation advice based on your soil and climate.',
    'price_prediction': 'Price Prediction',
    'price_prediction_subtitle': 'Estimate current mandi prices for your produce, with optional photo detection.',
  ...
  'ta': {
    ...
    'crop_rotation': 'பயிர் சுழற்சி',
    'crop_rotation_subtitle': 'உங்கள் மண் மற்றும் காலநிலையின் அடிப்படையில் AI பயிர் சுழற்சி ஆலோசனை பெறுங்கள்.',
    'price_prediction': 'விலை கணிப்பு',
    'price_prediction_subtitle': 'உங்கள் விளைபொருட்களுக்கான தற்போதைய மார்க்கெட் விலைகளை மதிப்பிடுங்கள்.',
    'get_price_estimate': 'விலை மதிப்பீடு பெறு',
    'soil_type': 'மண் வகை',
    'previous_crop': 'முந்தைய பயிர்',
    'temperature_c': 'வெப்பநிலை (°C)',
    'humidity_percent': 'ஈரப்பதம் (%)',
    'rainfall_mm': 'மழை (mm)',
    'get_recommendation': 'பரிந்துரை பெறு',
  },
};
